...
export class DatabaseConfigService implements TypeOrmOptionsFactory {
  ...
  createTypeOrmOptions(): TypeOrmModuleOptions {
    return {
      ...
      username: this.configService.get<string>('DB_USERNAME', 'coworking_notification_user'),
      password: this.configService.get<string>('DB_PASSWORD', 'coworking_notification_password'),
      database: this.configService.get<string>('DB_DATABASE', 'coworking_notifications'),
      ...
      cache: {
        ...
        options: {
          ...
          db: this.configService.get<number>('REDIS_DB', 5),
        },
      },
