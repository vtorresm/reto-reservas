...
export class DatabaseConfigService implements TypeOrmOptionsFactory {
  ...
  createTypeOrmOptions(): TypeOrmModuleOptions {
    return {
      ...
      username: this.configService.get<string>('DB_USERNAME', 'coworking_audit_user'),
      password: this.configService.get<string>('DB_PASSWORD', 'coworking_audit_password'),
      database: this.configService.get<string>('DB_DATABASE', 'coworking_audit'),
      ...
      cache: {
        ...
        options: {
          ...
          db: this.configService.get<number>('REDIS_DB', 7),
        },
      },
