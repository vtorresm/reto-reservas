...
export class DatabaseConfigService implements TypeOrmOptionsFactory {
  ...
  createTypeOrmOptions(): TypeOrmModuleOptions {
    return {
      ...
      username: this.configService.get<string>('DB_USERNAME', 'coworking_booking_user'),
      password: this.configService.get<string>('DB_PASSWORD', 'coworking_booking_password'),
      database: this.configService.get<string>('DB_DATABASE', 'coworking_bookings'),
      ...
      cache: {
        ...
        options: {
          ...
          db: this.configService.get<number>('REDIS_DB', 3),
        },
      },
